...
import cat.vonblum.chatogt.usermanagement.api.config.shared.springboot.bus.shared.SpringbootBusProperties

/**
 * Resolves Kafka topics based on Spring Boot configuration and envelope type.
 */
class KafkaTopicResolver(
    private val properties: SpringbootBusProperties
) {
